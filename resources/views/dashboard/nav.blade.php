        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                @if(Auth::user()->role == 'admin')
                    <li><a href="{{url('newsCategory')}}"><i class='fa fa-link'></i>
                            <span>{{ trans('News category') }}</span></a>
                    </li>
                @endif
                @if(Auth::user()->role == 'admin')
                    <li><a href="{{url('users')}}"><i class='fa fa-link'></i> <span>{{ trans('Users') }}</span></a></li>
                @endif
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li>
                            <a href="{{url('showNews')}}"> Show News</a>
                        </li>
                    </ul>
                </li>
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="{{url('createVideo')}}">Upload Video</a>
                        </li>
                        <li>
